...
**Automatically analyze customer feedback using AI and route it to the right team channels — eliminating manual triage and enabling real-time sentiment tracking.**

### ❌ The Problem

- Manual reading and categorization of every customer submission
- Slow response times due to human triage bottlenecks
- Prone to misrouting and classification errors
- No systematic tracking of sentiment or recurring issues
- Image attachments require additional manual review
- Valuable customer insights lost in cluttered inboxes
...
An end-to-end intelligent automation that:

- Captures customer feedback via public web form
- Analyzes sentiment automatically (Positive, Negative, Neutral)
- Classifies feedback into relevant categories without manual tagging
- Extracts keywords from uploaded images using vision capabilities
- Stores all processed data in a database for tracking and analytics
- Routes feedback to the appropriate team channel using smart decisions
- Sends rich notifications with complete feedback details and insights
...
3. Choose `AI-Powered-Customer-Feedback-Automation.json` from the `workflows` directory
...
**Neloy Barman** – AI Agent Builder **|** Automation Engineer **|** Chatbot Developer
...
- 📧 Email: neloyupwork018@gmail.com
...
<sub>📝 Documentation crafted with assistance from <a href="https://claude.ai">Claude AI</a></sub>
